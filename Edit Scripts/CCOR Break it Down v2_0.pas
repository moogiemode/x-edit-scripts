{
  Break It Down v2.0
  created by matortheeternal, modified by danielleonyett
...
begin
  ...
  seev(condition, 'CTDA - CTDA\Type', '11000000'); // Greater than or equal to
  seev(condition, 'CTDA - CTDA\Comparison Value', '1.0');
  seev(condition, 'CTDA - CTDA\Function', 'GetItemCount');
  seev(condition, 'CTDA - CTDA\Inventory Object', s);
  
  if eqc then begin
    condition := ElementAssign(conditions, HighInteger, nil, False);
    seev(condition, 'CTDA - CTDA\Type', '10010000'); // Equal to / OR
    seev(condition, 'CTDA - CTDA\Comparison Value', '0.0');
    seev(condition, 'CTDA - CTDA\Function', 'GetEquipped');
    seev(condition, 'CTDA - CTDA\Inventory Object', s);

    condition := ElementAssign(conditions, HighInteger, nil, False);
    seev(condition, 'CTDA - CTDA\Type', '01000100'); // Greater than / Use global
    seev(condition, 'CTDA - CTDA\Comparison Value', 'PRUFEI_EquippedProtectedAmt [GLOB:01CC1118]');
    seev(condition, 'CTDA - CTDA\Function', 'GetItemCount');
    seev(condition, 'CTDA - CTDA\Inventory Object', s);
    ...
    seev(condition, 'CTDA - CTDA\Comparison Value', '0.0');
    seev(condition, 'CTDA - CTDA\Function', 'GetItemCount');
    seev(condition, 'CTDA - CTDA\Run On', 'Reference');
    seev(condition, 'CTDA - CTDA\Inventory Object', s);
    seev(condition, 'CTDA - CTDA\Reference', '[REFR:01CC1112] (places PRUFEIChest "PRUFEI Chest" [CONT:01CC1111] in GRUP Cell Persistent Children of WarehouseCrafting "Warehouse Crafting" [CELL:00104871])');

    condition := ElementAssign(conditions, HighInteger, nil, False);
    seev(condition, 'CTDA - CTDA\Type', '01000100'); // Greater than / Use global
    seev(condition, 'CTDA - CTDA\Comparison Value', 'PRUFEI_FavoriteProtectedAmt [GLOB:01CC1117]');
    seev(condition, 'CTDA - CTDA\Function', 'GetItemCount');
    seev(condition, 'CTDA - CTDA\Inventory Object', s);
  end;
end;
