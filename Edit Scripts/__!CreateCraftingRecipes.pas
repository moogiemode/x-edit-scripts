...
function Process(e: IInterface): integer;
	var
		recipe, recipeItem, items: IInterface;
		keyword, recipeFormId, destinationFileName: string;
	...
	begin
		...
		if not newFileCreated then begin
            destinationFileName := StringReplace(StringReplace(StringReplace(GetFileName(e), '[', '', [rfReplaceAll]), ']', ' -', [rfReplaceAll]), '_', ' ', [rfReplaceAll]);
			destinationFile := AddNewFileName('[Craft] ' + destinationFileName);
